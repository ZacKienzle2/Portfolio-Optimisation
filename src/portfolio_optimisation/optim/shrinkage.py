...
def linear_shrinkage_covariance(returns: pd.DataFrame) -> pd.DataFrame:
    ...
    Args:
        returns: Asset returns; rows observations, columns assets.
...
def nonlinear_shrinkage_covariance(returns: pd.DataFrame) -> pd.DataFrame:
    ...
    Args:
        returns: Asset returns; rows observations, columns assets. At least two
    ...
    if n_raw < 2:
        msg = "nonlinear shrinkage requires at least two observations."
