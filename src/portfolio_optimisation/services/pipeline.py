    ...
    def run(
        ...
        *,
        ...
        Args:
            ...
            start_date: ISO date for history start.
            use_copula: If True simulate via t-copula; if False fall back to bootstrap
...
def build_pipeline_from_settings(
    ...
    Args:
        ...
        console: Rich console for data-layer status output.
