...
def fit_garch(
    ...
    *,
    ...
    Args:
        ...
        vol: Volatility process, ``"GARCH"``, ``"EGARCH"`` or ``"GJR"``.
        p: Number of lagged volatility (ARCH) terms.
        q: Number of lagged variance (GARCH) terms.
        o: Number of asymmetry terms, at least one for ``"GJR"``.
        dist: Innovation distribution, ``"normal"`` or ``"t"``.

    Returns:
        The fitted ``arch`` result, in percent units.
    """
